...
class BuildExe:
    def __init__(self):
        ...
        self.script = "game.py"
        # 游戏名
        self.project_name = "飞机大作战"
        # 游戏site
        self.project_url = "planeflight.xiaomo.info"
        # 游戏版本
        self.project_version = "v1.0"
        # 游戏许可
        self.license = "MIT"
        # 游戏作者
        self.author_name = "xiaomo"
        # 联系电邮
        self.author_email = "xiaomo@xiaomo.info"
        # 游戏版权
        self.copyright = "Copyright (c) xiaomo."
        # 游戏描述
        self.project_description = "this is a plane fight game with python"
